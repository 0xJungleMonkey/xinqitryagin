...
func init() {
	...
	tables["active_admin_comments"] = active_admin_commentsTableInfo
	tables["active_storage_attachments"] = active_storage_attachmentsTableInfo
	tables["active_storage_blobs"] = active_storage_blobsTableInfo
	tables["addresses"] = addressesTableInfo
	tables["admin_users"] = admin_usersTableInfo
	tables["ar_internal_metadata"] = ar_internal_metadataTableInfo
	tables["batteries"] = batteriesTableInfo
	tables["blazer_audits"] = blazer_auditsTableInfo
	tables["blazer_checks"] = blazer_checksTableInfo
	tables["blazer_dashboard_queries"] = blazer_dashboard_queriesTableInfo
	tables["blazer_dashboards"] = blazer_dashboardsTableInfo
	tables["blazer_queries"] = blazer_queriesTableInfo
	tables["building_details"] = building_detailsTableInfo
	tables["buildings"] = buildingsTableInfo
	tables["columns"] = columnsTableInfo
	tables["customers"] = customersTableInfo
	tables["elevators"] = elevatorsTableInfo
	tables["employees"] = employeesTableInfo
	tables["interventions"] = interventionsTableInfo
	tables["leads"] = leadsTableInfo
	tables["maps"] = mapsTableInfo
	tables["quotes"] = quotesTableInfo
